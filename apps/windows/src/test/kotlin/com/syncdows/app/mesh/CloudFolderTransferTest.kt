...
class CloudFolderTransferTest {
    ...
    private class Fixture(shareKeys: Boolean = true) : AutoCloseable {
        ...
        val a = WindowsDeviceIdentity("A", dir.resolve("a.p12"), legacyKeyStoreFactory = null)
        val b = WindowsDeviceIdentity("B", dir.resolve("b.p12"), legacyKeyStoreFactory = null)
        ...
        init {
            ...
            folders = listOf("Saves", "Photos").map { name -> FolderAnnouncement.create(profile.groupId, name, emptyList(), emptyList(), a).also(sa::applyFolder) }
