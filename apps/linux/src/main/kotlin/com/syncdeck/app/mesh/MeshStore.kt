...
class MeshStore(databasePath: Path = defaultDatabasePath()) : AutoCloseable {
    ...
    fun importBundle(
        ...
        if (existing == null) {
            ...
            require(existing.groupId == groupId) { "This device already belongs to a different mesh" }
        }
    ...
    companion object {
        fun defaultDatabasePath(): Path = Path.of(
            com.syncdeck.app.platform.LinuxAppPaths.stateRoot.toString(), "syncdeck.db",
        )
    }
}
