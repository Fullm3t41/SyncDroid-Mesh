...
class MeshStore(databasePath: Path = defaultDatabasePath()) : AutoCloseable {
    ...
    fun importBundle(
        ...
        if (existing == null) {
            ...
            require(existing.groupId == groupId) { "This Mac already belongs to a different mesh" }
        }
    ...
    companion object {
        fun defaultDatabasePath(): Path = Path.of(
            System.getProperty("user.home"), "Library", "Application Support", "SyncTosh", "synctosh.db",
        )
    }
}
