...
class FileContentSyncTest {
    ...
    fun wholeFilesUpdatesAndDeletionsSyncBetweenConfiguredPeers() = runBlocking {
        val directory = Files.createTempDirectory("synctosh-content-session")
    ...
    fun partialBlocksResumeAfterStoreIsReopened() {
        val directory = Files.createTempDirectory("synctosh-resume")
    ...
    private suspend fun syncOnce(
        ...
        secondIdentity: MacDeviceIdentity,
    ...
    private fun signedFolder(groupId: String, signer: MacDeviceIdentity): FolderAnnouncement {
    ...
    private fun memoryIdentity(alias: String): MacDeviceIdentity {
        val path: Path = Files.createTempDirectory("synctosh-content-identity").resolve("identity.p12")
        return MacDeviceIdentity(alias, path, legacyKeyStoreFactory = null)
    }
